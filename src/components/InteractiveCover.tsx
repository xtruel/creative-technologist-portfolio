...
const POSTER_ANTI_STYLE_DRAGON = '/src/assets/images/anti_style_digimon_dragon_poster.png';
const POSTER_TOKYO_ARCHITECTURE = '/src/assets/images/tokyo_architecture_notebook_blue_yellow.png';
        ...
        <div className="lg:col-span-5 flex flex-col justify-center h-full select-none z-20">
          ...
          <div className="flex items-center space-x-3.5 mb-6 p-2.5 rounded-xl border border-neutral-900/10 bg-white/20 hover:bg-white/40 transition-all duration-300 backdrop-blur-sm group select-none max-w-sm">
            <div className="relative w-11 h-11 rounded-full overflow-hidden border border-neutral-900/20 shadow-sm flex-shrink-0">
              <img 
                src="/src/assets/images/eugenio_avatar_1782598579248.jpg" 
